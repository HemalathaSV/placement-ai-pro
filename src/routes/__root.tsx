...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Place AI uses a multi-agent system to analyze your resume, score ATS readiness, and generate a personalized placement roadmap." },
      { name: "author", content: "Place AI" },
